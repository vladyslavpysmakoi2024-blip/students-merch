...
const LoginPage = () => {
  ...
  return (
    <div className="login-container">
      {/* ДОДАНО: Спільна обгортка для картки та котів */}
        ...
        <div className="login-card">
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <div className="input-group">
              ...
              <div className="password-input-wrapper">
                ...
                <span
                  ...
                  role="button"
                >
                  {/* Іконки ока залишені без змін */}
                  {showPassword ? (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3D5690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3D5690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <path d="M4 14.5l-2 2" /><path d="M20 14.5l2 2" />
                      <path d="M8 17.5l-1 2" /><path d="M12 18.5v2" />
                      <path d="M16 17.5l1 2" />
                    </svg>
                  )}
                </span>
            ...
            <p className="signup-link">
              Ще не зареєстровані? <Link to="/registration">Зареєструватися!</Link>
            </p>
          </form>
        </div>
